            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 custom-navbar-ul">
                        ...
                        <li class="nav-item d-flex">
                            <?php ($pagActual == "servicios.php") ? include "icons/caret-right-fill.svg" : include "icons/caret-right.svg" ?>
                            <a class="nav-link <?php active($pagActual, "servicios.php") ?>" href="servicios.php">Servicios</a>
                        </li>
                        <li class="nav-item d-flex">
