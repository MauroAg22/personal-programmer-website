...
<head>
    ...
    <meta property="og:url" content="https://www.maurolucero.com.ar">
        ...
        <section class="row row-gap-5 justify-content-center">
            <div class="col-lg-7 col-md-9 order-lg-2">
                <div class="profile-section">
                    <img class="profile-pic" src="img/perfil-1.webp" alt="Foto de perfil">
                    <a class="download-cv gap-3 d-flex justify-content-center align-items-center" href="doc/mauro-lucero-cv.pdf" target="_blank">
            ...
            <div class="col-lg-5 col-md-9 order-lg-1">
                <section class="personal-info">
                    ...
                    <div>
                        ...
                        <span class="date">
                            <a href="https://wa.me/5492657281741" target="_blank" rel="noopener noreferrer">+54 9 2657 28-1741</a>
                        </span>
                    </div>
                    <div>
