...
function sumarPuntos() {
    ...
    if (puntos == necesario) {
        ...
        docFicha.removeEventListener('mouseover', sumarPuntos);
        esconderFicha();
    } else {
        actualizarPuntaje(puntos, necesario);
        moverFicha();
...
function moverFicha() {
    numeroAzar1 = Math.round(Math.random()*450);
    numeroAzar2 = Math.round(Math.random()*450);

    docFicha.style.marginTop = numeroAzar1 + 'px';
    docFicha.style.marginLeft = numeroAzar2 + 'px';
}
...
function iniciarJuego() {
    ...
    mostrarFicha();
    docFicha.addEventListener('mouseover', sumarPuntos);
    iniciarTiempo();
}
...
function mostrarFicha() {
    docFicha.style.background = 'rgba(205, 30, 30, 0.5)';
    docFicha.style.border = '2px solid rgb(255, 255, 255)';

    docFicha.style.margin = '200px 218px';
}
function esconderFicha() {
    docFicha.style.background = 'none';
    docFicha.style.border = 'none';
    docFicha.style.margin = '200px 218px';
}
function facil() {
